...
import type { StudentData, Assessment, MonthlyExam } from '../App';
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center text-white font-bold shadow-md ${
                                    percentage >= 85 ? 'bg-gradient-to-br from-emerald-500 to-teal-400' :
                   ...
                   <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                      <div className="flex items-start gap-4">
                         <div className={`p-4 rounded-2xl shadow-sm ${
                             stats.riskLevel === 'safe' ? 'bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400' :
                          ...
                          <div className="flex justify-between items-end">
                              ...
                              <div className="text-right">
                                  <span className={`text-2xl font-black ${
                                     stats.riskLevel === 'safe' ? 'text-green-600 dark:text-green-400' :
