...
export const Illustration: React.FC = () => {
  return (
    <div className="relative w-full max-w-[480px] aspect-square flex items-center justify-center perspective-[1000px]">
      ...
      <div className="absolute -right-4 top-10 z-20 bg-white p-3 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-50 flex items-center gap-3 animate-bounce" style={{ animationDuration: '3s' }}>
        <div className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center text-white"><CheckCircle2 className="w-5 h-5" /></div>
        <div className="text-xs font-bold text-slate-700">تم تسجيل الحضور</div>
      </div>

      <div className="absolute -left-8 bottom-20 z-20 bg-white p-3 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-50 flex items-center gap-3 animate-bounce" style={{ animationDuration: '4s', animationDelay: '1s' }}>
        <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold text-xs">A+</div>
        <div className="text-xs font-bold text-slate-700">درجة ممتازة</div>
      </div>
